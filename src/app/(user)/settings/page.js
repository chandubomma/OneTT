  ...
  return (
    <div>
      <div className='bg-gradient-to-b from-blue-300 to-gray-100 pb-8 pt-2 dark:bg-gradient-to-l dark:from-slate-900 dark:to-blue-900'>
        <h3 className='text-lg font-bold text-gray-600 m-4 dark:text-gray-100'>Account Details</h3>
        {
          session.data?
      ...
      <div>
        <h3 className='text-lg font-bold text-gray-600 m-4 dark:text-gray-100'>Watch List</h3>
        <h4 className='text-md fond-semibold text-gray-400 ml-5'>Your Watch List is Empty!</h4>
        <h3 className='text-lg font-bold text-gray-600 m-4 dark:text-gray-100'>Favourites List</h3>
        <h4 className='text-md fond-semibold text-gray-400 ml-5'>Your Favourites List is Empty!</h4>
      </div>
      <hr className='my-5'/>
      <div>
        <h3 className='text-lg font-bold text-gray-600 m-4 dark:text-gray-100'>Help & Support</h3>
        <hr className='my-3'/>
        <h3 className='text-lg font-bold text-gray-600 m-4 dark:text-gray-100'>About</h3>
        <hr className='my-3'/>
        {
          session.data?
          <Link href='/api/auth/signout' className='text-lg font-bold text-gray-600 m-4 dark:text-gray-100'>Sign Out</Link>:
          <Link href='/api/auth/signin' className='text-lg font-bold text-gray-600 m-4 dark:text-gray-100'>Sign In</Link>
        }
      </div>
      <div className='flex w-screen justify-center my-10'>
        <h4 className='text-md fond-semibold text-gray-400 ml-5'>OneTT Your Movie Companion, 2023.</h4>
      </div>
    </div>
  )
}
